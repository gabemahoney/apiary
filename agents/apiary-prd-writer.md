...
description: Apiary PRD Writer — drafts a Product Requirements Document from interview answers gathered by the calling agent, and creates/updates the PRD child bee. Cannot talk to the user; all requirements arrive in the dispatch prompt.
